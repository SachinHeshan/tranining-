...
var preloaditems = {
  images: [],
  sounds: null,
  jsonURL: "./assets/data/slide9.json",
};
...
function slideSequence(seqNo) {
  ...
  switch (seqNo) {
    case 1:
      ...
      // }, speedcal(5000));
      parent.surala.audio.playSound("IPM_S10L01u02_043", null, function () {
        if (sliderChanged) {
          sliderChanged = false;
        } else {
          seqNo = 2;
      ...
      break;
    case 2:
      parent.surala.audio.playSound("IPM_S10L01u02_044", null, function () {
        if (sliderChanged) {
          sliderChanged = false;
        } else {
          parent.surala.character.stopAllAnimation();
